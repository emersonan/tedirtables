  ...
  var DataTable = /*#__PURE__*/function () {
    ...
    _createClass(DataTable, [{
      ...
      value: function render() {
        ...
        var inner = ["<div class='", o.classes.top, "'>", o.layout.top, "</div>", "<div class='", o.classes.container, "'></div>", "<div class='", o.classes.bottom, "'>", o.layout.bottom, "</div>"].join(""); // Info placement
